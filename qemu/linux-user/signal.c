...
// TODO : We have to migrate the codes from arch/x86_64/signal.c
...
{
    fprintf(stderr, "x86_64 setup_frame: not implemented\n");
}
...
static void setup_rt_frame(int sig, struct target_sigaction *ka,
			   ...
			   target_sigset_t *set, CPUArchState *env)
{
    fprintf(stderr, "x86_64 setup_rt_frame: not implemented\n");
}

long do_sigreturn(CPUArchState *env)
{
    fprintf(stderr, "x86_64 do_sigreturn: not implemented\n");
    return -TARGET_ENOSYS;
}

long do_rt_sigreturn(CPUArchState *env)
{
    fprintf(stderr, "x86_64 do_rt_sigreturn: not implemented\n");
    return -TARGET_ENOSYS;
} */
